...
def search_and_scrape(page, keyword, page_number, delay=3):
    base_url = 'https://www.amazon.it/s?k='
...
def main(keyword, pages=7, num_tabs=1, delay=3):
    all_products = []
    ...
    df.to_excel(f'{keyword}_products_it.xlsx', index=False)
...
# 主程序
keywords ='Magnetici Blocchi Costruzione Magneti'
